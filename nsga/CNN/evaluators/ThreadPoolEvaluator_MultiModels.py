...
class ThreadPoolEvaluator_MultiModels:
	def __init__(self, dataset_filename, population_path, num_threads, population_size):
		...
		for i in range(num_threads):
			...
			evaluator_list.append( MultiNetworkEvaluator(dataset_filename=dataset_filename, num_models=2, population_path=population_path_device, gpu_id=device_id) )
